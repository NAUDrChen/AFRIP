"""Support utilities copied from Ultralytics modules for AFRIP graph blocks."""
...
def multi_scale_deformable_attn_pytorch(
    ...
    for level, (height, width) in enumerate(value_spatial_shapes):
        value_level = value_list[level].flatten(2).transpose(1, 2).reshape(bs * num_heads, embed_dims, height, width)
